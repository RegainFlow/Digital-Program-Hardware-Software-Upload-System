      ...
      <div className="flex items-center justify-between mb-8">
        <div>
           <div className="flex items-center gap-3 mb-1">
             ...
             <h2 className="text-2xl font-bold font-logo text-white">AI Normalization</h2>
           </div>
           <p className="text-gray-400 text-sm ml-14">
             Gemini detected {autoMapCount} probable matches for <span className="text-white font-mono">{fileData.fileName}</span>
           </p>
        </div>
